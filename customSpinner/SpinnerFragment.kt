package br.com.bayer.podtraitdetection.util
...
import br.com.bayer.podtraitdetection.features.cargo_type.presentation.CargoTypeSelectFragment
        ...
        try {
            ...
            builder.setItems(listId, DialogInterface.OnClickListener { dialog, pos ->
                    ...
                    if (!TextUtils.isEmpty(selectedText)) {
                        ...
                        CargoTypeSelectFragment.control_carga = et.text.toString()
                        CargoTypeSelectFragment.optionNumber.visibility = View.VISIBLE
                    } else {
                        et.text.clear()
                    }
                })
